...
use N8G\Grass\Components\Html\ListItem;
use N8G\Utils\Log;
...
class ListItemTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		...
		$this->assertInstanceOf('N8G\Grass\Components\Html\ListItem', $element);

		//Just content
		$element = new ListItem($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\ListItem', $element);

		//Content and ID
		$element = new ListItem($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\ListItem', $element);

		//Content, ID and elements
		$element = new ListItem($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\ListItem', $element);

		//Content, ID, Elements and attributes
		$element = new ListItem($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\ListItem', $element);
	}
	...
	{
		$element = new ListItem('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'List Item element';
		$data[1]['fixture'] = 'List Item element\n\r    Content: Test';
		$data[2]['fixture'] = 'List Item element\n\r    ID: test';
		$data[3]['fixture'] = 'List Item element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'List Item element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'List Item element\n\r    Content: 1';
		$data[6]['fixture'] = 'List Item element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<li></li>';
		$data[1]['fixture'] = '<li>Test</li>';
		$data[2]['fixture'] = '<li id="test"></li>';
		$data[3]['fixture'] = '<li>PHPUnit is...fun!</li>';
		$data[4]['fixture'] = '<li class="test"></li>';
		$data[5]['fixture'] = '<li>1</li>';
		$data[6]['fixture'] = '<li id="1"></li>';
