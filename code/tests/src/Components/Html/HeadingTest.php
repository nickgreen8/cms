...
use N8G\Grass\Components\Html\Heading;
use N8G\Utils\Log;
...
class HeadingTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		//No arguments
		$element = new Heading(1);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Heading', $element);

		//Just content
		$element = new Heading(1, $content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Heading', $element);

		//Content and ID
		$element = new Heading(1, $content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Heading', $element);

		//Content, ID and elements
		$element = new Heading(1, $content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Heading', $element);

		//Content, ID, Elements and attributes
		$element = new Heading(1, $content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Heading', $element);
	}
	...
	{
		$element = new Heading(1, 'This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Heading element';
		$data[1]['fixture'] = 'Heading element\n\r    Content: Test';
		$data[2]['fixture'] = 'Heading element\n\r    ID: test';
		$data[3]['fixture'] = 'Heading element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Heading element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Heading element\n\r    Content: 1';
		$data[6]['fixture'] = 'Heading element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<h1></h1>';
		$data[1]['fixture'] = '<h1>Test</h1>';
		$data[2]['fixture'] = '<h1 id="test"></h1>';
		$data[3]['fixture'] = '<h1>PHPUnit is...fun!</h1>';
		$data[4]['fixture'] = '<h1 class="test"></h1>';
		$data[5]['fixture'] = '<h1>1</h1>';
		$data[6]['fixture'] = '<h1 id="1"></h1>';
