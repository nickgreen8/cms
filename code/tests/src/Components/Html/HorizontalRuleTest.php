...
use N8G\Grass\Components\Html\HorizontalRule;
use N8G\Utils\Log;
...
class HorizontalRuleTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		...
		$this->assertInstanceOf('N8G\Grass\Components\Html\HorizontalRule', $element);

		//Just ID
		$element = new HorizontalRule($id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\HorizontalRule', $element);

		//ID and attributes
		$element = new HorizontalRule($id, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\HorizontalRule', $element);
	}
	...
	{
		$element = new HorizontalRule($content, $id, $elements, $attributes);
	}
	...
	{
		$element = new HorizontalRule('test', array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Horizontal Rule element';
		$data[1]['fixture'] = 'Horizontal Rule element';
		$data[2]['fixture'] = 'Horizontal Rule element\n\r    ID: test';
		$data[3]['fixture'] = 'Horizontal Rule element';
		$data[4]['fixture'] = 'Horizontal Rule element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Horizontal Rule element';
		$data[6]['fixture'] = 'Horizontal Rule element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		$data[0]['fixture'] = '<hr />';
		$data[1]['fixture'] = '<hr />';
		$data[2]['fixture'] = '<hr id="test" />';
		$data[3]['fixture'] = '<hr />';
		$data[4]['fixture'] = '<hr class="test" />';
		$data[5]['fixture'] = '<hr />';
		$data[6]['fixture'] = '<hr id="1" />';
