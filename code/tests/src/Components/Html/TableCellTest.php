...
use N8G\Grass\Components\Html\TableCell;
use N8G\Utils\Log;
...
class TableCellTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		...
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableCell', $element);

		//Just content
		$element = new TableCell($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableCell', $element);

		//Content and ID
		$element = new TableCell($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableCell', $element);

		//Content, ID and elements
		$element = new TableCell($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableCell', $element);

		//Content, ID, Elements and attributes
		$element = new TableCell($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableCell', $element);
	}
	...
	{
		$element = new TableCell('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Table Cell element';
		$data[1]['fixture'] = 'Table Cell element\n\r    Content: Test';
		$data[2]['fixture'] = 'Table Cell element\n\r    ID: test';
		$data[3]['fixture'] = 'Table Cell element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Table Cell element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Table Cell element\n\r    Content: 1';
		$data[6]['fixture'] = 'Table Cell element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<td></td>';
		$data[1]['fixture'] = '<td>Test</td>';
		$data[2]['fixture'] = '<td id="test"></td>';
		$data[3]['fixture'] = '<td>PHPUnit is...fun!</td>';
		$data[4]['fixture'] = '<td class="test"></td>';
		$data[5]['fixture'] = '<td>1</td>';
		$data[6]['fixture'] = '<td id="1"></td>';
