...
use N8G\Grass\Components\Html\Button;
use N8G\Utils\Log;
...
class ButtonTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Button();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Button', $element);
		...
		//Content and ID
		$element = new Button($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Button', $element);

		//Content, ID and elements
		$element = new Button($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Button', $element);

		//Content, ID, Elements and attributes
		$element = new Button($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Button', $element);
	}
	...
	{
		$element = new Button('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function testValidateAttributes()
	{
		...
		//Test all the valid values of the button
		$element->setAttributes(array('type' => 'button'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('type' => 'submit'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('type' => 'reset'));
		$this->invokeMethod($element, 'validateAttributes');
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Button element\n\r    Attributes: type=button';
		$data[1]['fixture'] = 'Button element\n\r    Content: Test\n\r    Attributes: type=button';
		$data[2]['fixture'] = 'Button element\n\r    ID: test\n\r    Attributes: type=button';
		$data[3]['fixture'] = 'Button element\n\r    Elements:\n\rPHPUnit is...fun!\n\r    Attributes: type=button';
		$data[4]['fixture'] = 'Button element\n\r    Attributes: class=test, type=button';
		$data[5]['fixture'] = 'Button element\n\r    Content: 1\n\r    Attributes: type=button';
		$data[6]['fixture'] = 'Button element\n\r    ID: 1\n\r    Attributes: type=button';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<button type="button"></button>';
		$data[1]['fixture'] = '<button type="button">Test</button>';
		$data[2]['fixture'] = '<button id="test" type="button"></button>';
		$data[3]['fixture'] = '<button type="button">PHPUnit is...fun!</button>';
		$data[4]['fixture'] = '<button class="test" type="button"></button>';
		$data[5]['fixture'] = '<button type="button">1</button>';
		$data[6]['fixture'] = '<button id="1" type="button"></button>';
	...
	private function genericDataProvider()
	{
		return array(
			...
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('class' => 'test', 'type' => 'button')
			),
			array(
				'content'		=>	1,
				'id'			=>	null,
