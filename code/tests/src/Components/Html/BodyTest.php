...
class BodyTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Body();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Body', $element);
		...
		//Content and ID
		$element = new Body($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Body', $element);

		//Content, ID and elements
		$element = new Body($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Body', $element);

		//Content, ID, Elements and attributes
		$element = new Body($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Body', $element);
	}
	...
	{
		$element = new Body('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Body element';
		$data[1]['fixture'] = 'Body element\n\r    Content: Test';
		$data[2]['fixture'] = 'Body element\n\r    ID: test';
		$data[3]['fixture'] = 'Body element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Body element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Body element\n\r    Content: 1';
		$data[6]['fixture'] = 'Body element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<body></body>';
		$data[1]['fixture'] = '<body>Test</body>';
		$data[2]['fixture'] = '<body id="test"></body>';
		$data[3]['fixture'] = '<body>PHPUnit is...fun!</body>';
		$data[4]['fixture'] = '<body class="test"></body>';
		$data[5]['fixture'] = '<body>1</body>';
		$data[6]['fixture'] = '<body id="1"></body>';
