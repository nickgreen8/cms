...
use N8G\Grass\Components\Html\TableBody;
use N8G\Utils\Log;
...
class TableBodyTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		//No arguments
		$element = new TableBody();
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableBody', $element);

		//Just content
		$element = new TableBody($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableBody', $element);

		//Content and ID
		$element = new TableBody($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableBody', $element);

		//Content, ID and elements
		$element = new TableBody($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableBody', $element);

		//Content, ID, Elements and attributes
		$element = new TableBody($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableBody', $element);
	}
	...
	{
		$element = new TableBody('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Table Body element';
		$data[1]['fixture'] = 'Table Body element\n\r    Content: Test';
		$data[2]['fixture'] = 'Table Body element\n\r    ID: test';
		$data[3]['fixture'] = 'Table Body element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Table Body element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Table Body element\n\r    Content: 1';
		$data[6]['fixture'] = 'Table Body element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<tbody></tbody>';
		$data[1]['fixture'] = '<tbody>Test</tbody>';
		$data[2]['fixture'] = '<tbody id="test"></tbody>';
		$data[3]['fixture'] = '<tbody>PHPUnit is...fun!</tbody>';
		$data[4]['fixture'] = '<tbody class="test"></tbody>';
		$data[5]['fixture'] = '<tbody>1</tbody>';
		$data[6]['fixture'] = '<tbody id="1"></tbody>';
