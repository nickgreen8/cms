...
use N8G\Grass\Components\Html\Option;
use N8G\Utils\Log;
...
class OptionTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Option();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Option', $element);

		//Just content
		$element = new Option($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Option', $element);

		//Content and ID
		$element = new Option($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Option', $element);

		//Content, ID and elements
		$element = new Option($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Option', $element);

		//Content, ID, Elements and attributes
		$element = new Option($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Option', $element);
	}
	...
	{
		$element = new Option('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function testValidateAttributes()
	{
		...
		//Test all the valid values of the Option
		$element->setAttributes(array('value' => 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Combobox Option element\n\r    Attributes: value=test';
		$data[1]['fixture'] = 'Combobox Option element\n\r    Content: Test\n\r    Attributes: value=test';
		$data[2]['fixture'] = 'Combobox Option element\n\r    ID: test\n\r    Attributes: value=test';
		$data[3]['fixture'] = 'Combobox Option element\n\r    Elements:\n\rPHPUnit is...fun!\n\r    Attributes: value=test';
		$data[4]['fixture'] = 'Combobox Option element\n\r    Attributes: class=test, value=test';
		$data[5]['fixture'] = 'Combobox Option element\n\r    Content: 1\n\r    Attributes: value=test';
		$data[6]['fixture'] = 'Combobox Option element\n\r    ID: 1\n\r    Attributes: value=test';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<option value="test"></option>';
		$data[1]['fixture'] = '<option value="test">Test</option>';
		$data[2]['fixture'] = '<option id="test" value="test"></option>';
		$data[3]['fixture'] = '<option value="test">PHPUnit is...fun!</option>';
		$data[4]['fixture'] = '<option class="test" value="test"></option>';
		$data[5]['fixture'] = '<option value="test">1</option>';
		$data[6]['fixture'] = '<option id="1" value="test"></option>';
	...
	private function genericDataProvider()
	{
		return array(
			...
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('class' => 'test', 'value' => 'test')
			),
			array(
				'content'		=>	1,
				'id'			=>	null,
