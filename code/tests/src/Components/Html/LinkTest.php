...
use N8G\Grass\Components\Html\Link;
use N8G\Utils\Log;
...
class LinkTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Link();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Link', $element);

		//Attributes
		$element = new Link($attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Link', $element);
	}
	...
	{
		$element = new Link($content, $id, $elements, $attributes);
	}
	...
	{
		$element = new Link(array('class' =>'test'));
	...
	public function testValidateAttributes()
	{
		...
		//Test all the valid values of the Link
		$element->setAttributes(array('rel' => 'test', 'type' => 'test', 'href' => 'test'));
		...
		$element->setAttributes(array('type' => 'test', 'href' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('rel' => 'test', 'href' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('rel' => 'test', 'type' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('href' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('rel' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('type' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');
	}
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Link element\n\r    Attributes: rel=test, type=test, href=test';
		$data[1]['fixture'] = 'Link element\n\r    Attributes: rel=test, type=test, href=test';
		$data[2]['fixture'] = 'Link element\n\r    Attributes: rel=test, type=test, href=test';
		$data[3]['fixture'] = 'Link element\n\r    Attributes: rel=test, type=test, href=test';
		$data[4]['fixture'] = 'Link element\n\r    Attributes: class=test, rel=test, type=test, href=test';
		$data[5]['fixture'] = 'Link element\n\r    Attributes: rel=test, type=test, href=test';
		$data[6]['fixture'] = 'Link element\n\r    Attributes: rel=test, type=test, href=test';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<link rel="test" type="test" href="test"></link>';
		$data[1]['fixture'] = '<link rel="test" type="test" href="test"></link>';
		$data[2]['fixture'] = '<link rel="test" type="test" href="test"></link>';
		$data[3]['fixture'] = '<link rel="test" type="test" href="test"></link>';
		$data[4]['fixture'] = '<link class="test" rel="test" type="test" href="test"></link>';
		$data[5]['fixture'] = '<link rel="test" type="test" href="test"></link>';
		$data[6]['fixture'] = '<link rel="test" type="test" href="test"></link>';
	...
	private function genericDataProvider()
	{
		return array(
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('rel' => 'test', 'type' => 'test', 'href' => 'test')
			),
			array(
				'content'		=>	'Test',
				'id'			=>	null,
			...
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('class' => 'test', 'rel' => 'test', 'type' => 'test', 'href' => 'test')
			),
			array(
				'content'		=>	1,
				'id'			=>	null,
