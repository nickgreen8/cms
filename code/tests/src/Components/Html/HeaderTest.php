...
use N8G\Grass\Components\Html\Header;
use N8G\Utils\Log;
...
class HeaderTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Header();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Header', $element);
		...
		//Content and ID
		$element = new Header($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Header', $element);

		//Content, ID and elements
		$element = new Header($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Header', $element);

		//Content, ID, Elements and attributes
		$element = new Header($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Header', $element);
	}
	...
	{
		$element = new Header('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Header element';
		$data[1]['fixture'] = 'Header element\n\r    Content: Test';
		$data[2]['fixture'] = 'Header element\n\r    ID: test';
		$data[3]['fixture'] = 'Header element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Header element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Header element\n\r    Content: 1';
		$data[6]['fixture'] = 'Header element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<header></header>';
		$data[1]['fixture'] = '<header>Test</header>';
		$data[2]['fixture'] = '<header id="test"></header>';
		$data[3]['fixture'] = '<header>PHPUnit is...fun!</header>';
		$data[4]['fixture'] = '<header class="test"></header>';
		$data[5]['fixture'] = '<header>1</header>';
		$data[6]['fixture'] = '<header id="1"></header>';
