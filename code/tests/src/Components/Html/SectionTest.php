...
use N8G\Grass\Components\Html\Section;
use N8G\Utils\Log;
...
class SectionTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Section();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Section', $element);

		//Just content
		$element = new Section($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Section', $element);

		//Content and ID
		$element = new Section($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Section', $element);

		//Content, ID and elements
		$element = new Section($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Section', $element);

		//Content, ID, Elements and attributes
		$element = new Section($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Section', $element);
	}
	...
	{
		$element = new Section('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Section element';
		$data[1]['fixture'] = 'Section element\n\r    Content: Test';
		$data[2]['fixture'] = 'Section element\n\r    ID: test';
		$data[3]['fixture'] = 'Section element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Section element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Section element\n\r    Content: 1';
		$data[6]['fixture'] = 'Section element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<section></section>';
		$data[1]['fixture'] = '<section>Test</section>';
		$data[2]['fixture'] = '<section id="test"></section>';
		$data[3]['fixture'] = '<section>PHPUnit is...fun!</section>';
		$data[4]['fixture'] = '<section class="test"></section>';
		$data[5]['fixture'] = '<section>1</section>';
		$data[6]['fixture'] = '<section id="1"></section>';
