...
use N8G\Grass\Components\Html\Image;
use N8G\Utils\Log;
...
class ImageTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Image();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Image', $element);
		...
		//ID and attributes
		$element = new Image($id, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Image', $element);
	}
	...
	{
		$element = new Image($content, $id, $elements, $attributes);
	}
	...
	{
		$element = new Image('test', array('class', 'test'));
	...
	public function testValidateAttributes()
	{
		...
		$element->setAttributes(array('src' => 'image.jpg', 'alt' => 'test'));
		...
		$element->setAttributes(array('alt' => 'test'));
		$this->invokeMethod($element, 'validateAttributes');

		$element->setAttributes(array('src' => 'image.jpg'));
		$this->invokeMethod($element, 'validateAttributes');
	}
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Image element\n\r    Attributes: src=image.jpg, alt=test';
		$data[1]['fixture'] = 'Image element\n\r    Attributes: src=image.jpg, alt=test';
		$data[2]['fixture'] = 'Image element\n\r    ID: test\n\r    Attributes: src=image.jpg, alt=test';
		$data[3]['fixture'] = 'Image element\n\r    Attributes: src=image.jpg, alt=test';
		$data[4]['fixture'] = 'Image element\n\r    Attributes: src=image.jpg, alt=test, class=test';
		$data[5]['fixture'] = 'Image element\n\r    Attributes: src=image.jpg, alt=test';
		$data[6]['fixture'] = 'Image element\n\r    ID: 1\n\r    Attributes: src=image.jpg, alt=test';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<img src="image.jpg" alt="test" />';
		$data[1]['fixture'] = '<img src="image.jpg" alt="test" />';
		$data[2]['fixture'] = '<img src="image.jpg" alt="test" id="test" />';
		$data[3]['fixture'] = '<img src="image.jpg" alt="test" />';
		$data[4]['fixture'] = '<img src="image.jpg" alt="test" class="test" />';
		$data[5]['fixture'] = '<img src="image.jpg" alt="test" />';
		$data[6]['fixture'] = '<img src="image.jpg" alt="test" id="1" />';
	...
	private function genericDataProvider()
	{
		return array(
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('src' => 'image.jpg', 'alt' => 'test')
			),
			array(
				'content'		=>	'Test',
				'id'			=>	null,
			...
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('src' => 'image.jpg', 'alt' => 'test', 'class' => 'test')
			),
			array(
				'content'		=>	1,
				'id'			=>	null,
