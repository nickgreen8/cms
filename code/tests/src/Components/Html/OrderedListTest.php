...
use N8G\Grass\Components\Html\OrderedList;
use N8G\Utils\Log;
...
class OrderedListTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		//No arguments
		$element = new OrderedList();
		$this->assertInstanceOf('N8G\Grass\Components\Html\OrderedList', $element);

		//Just content
		$element = new OrderedList($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\OrderedList', $element);

		//Content and ID
		$element = new OrderedList($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\OrderedList', $element);

		//Content, ID and elements
		$element = new OrderedList($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\OrderedList', $element);

		//Content, ID, Elements and attributes
		$element = new OrderedList($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\OrderedList', $element);
	}
	...
	{
		$element = new OrderedList('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Ordered List element';
		$data[1]['fixture'] = 'Ordered List element\n\r    Content: Test';
		$data[2]['fixture'] = 'Ordered List element\n\r    ID: test';
		$data[3]['fixture'] = 'Ordered List element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Ordered List element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Ordered List element\n\r    Content: 1';
		$data[6]['fixture'] = 'Ordered List element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<ol></ol>';
		$data[1]['fixture'] = '<ol>Test</ol>';
		$data[2]['fixture'] = '<ol id="test"></ol>';
		$data[3]['fixture'] = '<ol>PHPUnit is...fun!</ol>';
		$data[4]['fixture'] = '<ol class="test"></ol>';
		$data[5]['fixture'] = '<ol>1</ol>';
		$data[6]['fixture'] = '<ol id="1"></ol>';
