...
use N8G\Grass\Components\Html\Footer;
use N8G\Utils\Log;
...
class FooterTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Footer();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Footer', $element);
		...
		//Content and ID
		$element = new Footer($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Footer', $element);

		//Content, ID and elements
		$element = new Footer($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Footer', $element);

		//Content, ID, Elements and attributes
		$element = new Footer($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Footer', $element);
	}
	...
	{
		$element = new Footer('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Footer element';
		$data[1]['fixture'] = 'Footer element\n\r    Content: Test';
		$data[2]['fixture'] = 'Footer element\n\r    ID: test';
		$data[3]['fixture'] = 'Footer element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Footer element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Footer element\n\r    Content: 1';
		$data[6]['fixture'] = 'Footer element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<footer></footer>';
		$data[1]['fixture'] = '<footer>Test</footer>';
		$data[2]['fixture'] = '<footer id="test"></footer>';
		$data[3]['fixture'] = '<footer>PHPUnit is...fun!</footer>';
		$data[4]['fixture'] = '<footer class="test"></footer>';
		$data[5]['fixture'] = '<footer>1</footer>';
		$data[6]['fixture'] = '<footer id="1"></footer>';
