...
use N8G\Grass\Components\Html\TableHeading;
use N8G\Utils\Log;

class TableHeadingTest extends \PHPUnit_Framework_TestCase
{
	/**
	...
	{
		//No arguments
		$element = new TableHeading();
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeading', $element);

		//Just content
		$element = new TableHeading($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeading', $element);

		//Content and ID
		$element = new TableHeading($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeading', $element);

		//Content, ID and elements
		$element = new TableHeading($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeading', $element);

		//Content, ID, Elements and attributes
		$element = new TableHeading($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeading', $element);
	}
	...
	{
		$element = new TableHeading('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Table Heading element';
		$data[1]['fixture'] = 'Table Heading element\n\r    Content: Test';
		$data[2]['fixture'] = 'Table Heading element\n\r    ID: test';
		$data[3]['fixture'] = 'Table Heading element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Table Heading element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Table Heading element\n\r    Content: 1';
		$data[6]['fixture'] = 'Table Heading element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<th></th>';
		$data[1]['fixture'] = '<th>Test</th>';
		$data[2]['fixture'] = '<th id="test"></th>';
		$data[3]['fixture'] = '<th>PHPUnit is...fun!</th>';
		$data[4]['fixture'] = '<th class="test"></th>';
		$data[5]['fixture'] = '<th>1</th>';
		$data[6]['fixture'] = '<th id="1"></th>';
