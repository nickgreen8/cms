...
use N8G\Grass\Components\Html\Select;
use N8G\Utils\Log;
...
class SelectTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Select();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Select', $element);

		//Just content
		$element = new Select($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Select', $element);

		//Content and ID
		$element = new Select($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Select', $element);

		//Content, ID and elements
		$element = new Select($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Select', $element);

		//Content, ID, Elements and attributes
		$element = new Select($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Select', $element);
	}
	...
	{
		$element = new Select('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function testValidateAttributes()
	{
		...
		//Test all the valid values of the Select
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Combobox element\n\r    Attributes: name=test';
		$data[1]['fixture'] = 'Combobox element\n\r    Content: Test\n\r    Attributes: name=test';
		$data[2]['fixture'] = 'Combobox element\n\r    ID: test\n\r    Attributes: name=test';
		$data[3]['fixture'] = 'Combobox element\n\r    Elements:\n\rPHPUnit is...fun!\n\r    Attributes: name=test';
		$data[4]['fixture'] = 'Combobox element\n\r    Attributes: class=test, name=test';
		$data[5]['fixture'] = 'Combobox element\n\r    Content: 1\n\r    Attributes: name=test';
		$data[6]['fixture'] = 'Combobox element\n\r    ID: 1\n\r    Attributes: name=test';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<select name="test"></select>';
		$data[1]['fixture'] = '<select name="test">Test</select>';
		$data[2]['fixture'] = '<select id="test" name="test"></select>';
		$data[3]['fixture'] = '<select name="test">PHPUnit is...fun!</select>';
		$data[4]['fixture'] = '<select class="test" name="test"></select>';
		$data[5]['fixture'] = '<select name="test">1</select>';
		$data[6]['fixture'] = '<select id="1" name="test"></select>';
	...
	private function genericDataProvider()
	{
		return array(
			...
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('class' => 'test', 'name' => 'test')
			),
			array(
				'content'		=>	1,
				'id'			=>	null,
