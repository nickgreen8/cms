...
use N8G\Grass\Components\Html\Fieldset;
use N8G\Utils\Log;
...
class FieldsetTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		...
		$this->assertInstanceOf('N8G\Grass\Components\Html\Fieldset', $element);

		//Just content
		$element = new Fieldset($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Fieldset', $element);

		//Content and ID
		$element = new Fieldset($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Fieldset', $element);

		//Content, ID and elements
		$element = new Fieldset($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Fieldset', $element);

		//Content, ID, Elements and attributes
		$element = new Fieldset($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Fieldset', $element);
	}
	...
	{
		$element = new Fieldset('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Fieldset element';
		$data[1]['fixture'] = 'Fieldset element\n\r    Content: Test';
		$data[2]['fixture'] = 'Fieldset element\n\r    ID: test';
		$data[3]['fixture'] = 'Fieldset element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Fieldset element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Fieldset element\n\r    Content: 1';
		$data[6]['fixture'] = 'Fieldset element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<fieldset></fieldset>';
		$data[1]['fixture'] = '<fieldset>Test</fieldset>';
		$data[2]['fixture'] = '<fieldset id="test"></fieldset>';
		$data[3]['fixture'] = '<fieldset>PHPUnit is...fun!</fieldset>';
		$data[4]['fixture'] = '<fieldset class="test"></fieldset>';
		$data[5]['fixture'] = '<fieldset>1</fieldset>';
		$data[6]['fixture'] = '<fieldset id="1"></fieldset>';
