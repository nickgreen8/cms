...
use N8G\Grass\Components\Html\TableHeader;
use N8G\Utils\Log;

class TableHeaderTest extends \PHPUnit_Framework_TestCase
{
	/**
	...
	{
		//No arguments
		$element = new TableHeader();
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeader', $element);

		//Just content
		$element = new TableHeader($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeader', $element);

		//Content and ID
		$element = new TableHeader($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeader', $element);

		//Content, ID and elements
		$element = new TableHeader($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeader', $element);

		//Content, ID, Elements and attributes
		$element = new TableHeader($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableHeader', $element);
	}
	...
	{
		$element = new TableHeader('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Table Header Section element';
		$data[1]['fixture'] = 'Table Header Section element\n\r    Content: Test';
		$data[2]['fixture'] = 'Table Header Section element\n\r    ID: test';
		$data[3]['fixture'] = 'Table Header Section element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Table Header Section element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Table Header Section element\n\r    Content: 1';
		$data[6]['fixture'] = 'Table Header Section element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<thead></thead>';
		$data[1]['fixture'] = '<thead>Test</thead>';
		$data[2]['fixture'] = '<thead id="test"></thead>';
		$data[3]['fixture'] = '<thead>PHPUnit is...fun!</thead>';
		$data[4]['fixture'] = '<thead class="test"></thead>';
		$data[5]['fixture'] = '<thead>1</thead>';
		$data[6]['fixture'] = '<thead id="1"></thead>';
