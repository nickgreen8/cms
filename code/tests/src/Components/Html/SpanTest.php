...
use N8G\Grass\Components\Html\Span;
use N8G\Utils\Log;
...
class SpanTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Span();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Span', $element);
		...
		//Content and ID
		$element = new Span($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Span', $element);

		//Content, ID and elements
		$element = new Span($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Span', $element);

		//Content, ID, Elements and attributes
		$element = new Span($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Span', $element);
	}
	...
	{
		$element = new Span('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Span element';
		$data[1]['fixture'] = 'Span element\n\r    Content: Test';
		$data[2]['fixture'] = 'Span element\n\r    ID: test';
		$data[3]['fixture'] = 'Span element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Span element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Span element\n\r    Content: 1';
		$data[6]['fixture'] = 'Span element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<span></span>';
		$data[1]['fixture'] = '<span>Test</span>';
		$data[2]['fixture'] = '<span id="test"></span>';
		$data[3]['fixture'] = '<span>PHPUnit is...fun!</span>';
		$data[4]['fixture'] = '<span class="test"></span>';
		$data[5]['fixture'] = '<span>1</span>';
		$data[6]['fixture'] = '<span id="1"></span>';
