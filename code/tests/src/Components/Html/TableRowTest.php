...
use N8G\Grass\Components\Html\TableRow;
use N8G\Utils\Log;
...
class TableRowTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		...
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableRow', $element);

		//Just content
		$element = new TableRow($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableRow', $element);

		//Content and ID
		$element = new TableRow($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableRow', $element);

		//Content, ID and elements
		$element = new TableRow($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableRow', $element);

		//Content, ID, Elements and attributes
		$element = new TableRow($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\TableRow', $element);
	}
	...
	{
		$element = new TableRow('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Table Row element';
		$data[1]['fixture'] = 'Table Row element\n\r    Content: Test';
		$data[2]['fixture'] = 'Table Row element\n\r    ID: test';
		$data[3]['fixture'] = 'Table Row element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Table Row element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Table Row element\n\r    Content: 1';
		$data[6]['fixture'] = 'Table Row element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<tr></tr>';
		$data[1]['fixture'] = '<tr>Test</tr>';
		$data[2]['fixture'] = '<tr id="test"></tr>';
		$data[3]['fixture'] = '<tr>PHPUnit is...fun!</tr>';
		$data[4]['fixture'] = '<tr class="test"></tr>';
		$data[5]['fixture'] = '<tr>1</tr>';
		$data[6]['fixture'] = '<tr id="1"></tr>';
