...
use N8G\Grass\Components\Html\Title;
use N8G\Utils\Log;
...
class TitleTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Title();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Title', $element);

		//Just content
		$element = new Title($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Title', $element);

		//Content and ID
		$element = new Title($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Title', $element);

		//Content, ID and elements
		$element = new Title($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Title', $element);

		//Content, ID, Elements and attributes
		$element = new Title($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Title', $element);
	}
	...
	{
		$element = new Title('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Title element';
		$data[1]['fixture'] = 'Title element\n\r    Content: Test';
		$data[2]['fixture'] = 'Title element\n\r    ID: test';
		$data[3]['fixture'] = 'Title element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Title element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Title element\n\r    Content: 1';
		$data[6]['fixture'] = 'Title element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<title></title>';
		$data[1]['fixture'] = '<title>Test</title>';
		$data[2]['fixture'] = '<title id="test"></title>';
		$data[3]['fixture'] = '<title>PHPUnit is...fun!</title>';
		$data[4]['fixture'] = '<title class="test"></title>';
		$data[5]['fixture'] = '<title>1</title>';
		$data[6]['fixture'] = '<title id="1"></title>';
