...
use N8G\Grass\Components\Html\Div;
use N8G\Utils\Log;
...
class DivTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Div();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Div', $element);
		...
		//Content and ID
		$element = new Div($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Div', $element);

		//Content, ID and elements
		$element = new Div($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Div', $element);

		//Content, ID, Elements and attributes
		$element = new Div($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Div', $element);
	}
	...
	{
		$element = new Div('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Divisional Tag element';
		$data[1]['fixture'] = 'Divisional Tag element\n\r    Content: Test';
		$data[2]['fixture'] = 'Divisional Tag element\n\r    ID: test';
		$data[3]['fixture'] = 'Divisional Tag element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Divisional Tag element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Divisional Tag element\n\r    Content: 1';
		$data[6]['fixture'] = 'Divisional Tag element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<div></div>';
		$data[1]['fixture'] = '<div>Test</div>';
		$data[2]['fixture'] = '<div id="test"></div>';
		$data[3]['fixture'] = '<div>PHPUnit is...fun!</div>';
		$data[4]['fixture'] = '<div class="test"></div>';
		$data[5]['fixture'] = '<div>1</div>';
		$data[6]['fixture'] = '<div id="1"></div>';
