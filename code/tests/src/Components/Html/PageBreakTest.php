...
use N8G\Grass\Components\Html\PageBreak;
use N8G\Utils\Log;
...
class PageBreakTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		//No arguments
		$element = new PageBreak();
		$this->assertInstanceOf('N8G\Grass\Components\Html\PageBreak', $element);

		//Just ID
		$element = new PageBreak($id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\PageBreak', $element);

		//ID and attributes
		$element = new PageBreak($id, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\PageBreak', $element);
	}
	...
	{
		$element = new PageBreak($content, $id, $elements, $attributes);
	}
	...
	{
		$element = new PageBreak('test', array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Page Break element';
		$data[1]['fixture'] = 'Page Break element';
		$data[2]['fixture'] = 'Page Break element\n\r    ID: test';
		$data[3]['fixture'] = 'Page Break element';
		$data[4]['fixture'] = 'Page Break element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Page Break element';
		$data[6]['fixture'] = 'Page Break element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		$data[0]['fixture'] = '<br />';
		$data[1]['fixture'] = '<br />';
		$data[2]['fixture'] = '<br id="test" />';
		$data[3]['fixture'] = '<br />';
		$data[4]['fixture'] = '<br class="test" />';
		$data[5]['fixture'] = '<br />';
		$data[6]['fixture'] = '<br id="1" />';
