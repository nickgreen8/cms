...
use N8G\Grass\Components\Html\Table;
use N8G\Utils\Log;
...
class TableTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Table();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Table', $element);

		//Just content
		$element = new Table($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Table', $element);

		//Content and ID
		$element = new Table($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Table', $element);

		//Content, ID and elements
		$element = new Table($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Table', $element);

		//Content, ID, Elements and attributes
		$element = new Table($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Table', $element);
	}
	...
	{
		$element = new Table('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Table element';
		$data[1]['fixture'] = 'Table element\n\r    Content: Test';
		$data[2]['fixture'] = 'Table element\n\r    ID: test';
		$data[3]['fixture'] = 'Table element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Table element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Table element\n\r    Content: 1';
		$data[6]['fixture'] = 'Table element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<table></table>';
		$data[1]['fixture'] = '<table>Test</table>';
		$data[2]['fixture'] = '<table id="test"></table>';
		$data[3]['fixture'] = '<table>PHPUnit is...fun!</table>';
		$data[4]['fixture'] = '<table class="test"></table>';
		$data[5]['fixture'] = '<table>1</table>';
		$data[6]['fixture'] = '<table id="1"></table>';
