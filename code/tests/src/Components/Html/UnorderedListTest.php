...
use N8G\Grass\Components\Html\UnorderedList;
use N8G\Utils\Log;
...
class UnorderedListTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		//No arguments
		$element = new UnorderedList();
		$this->assertInstanceOf('N8G\Grass\Components\Html\UnorderedList', $element);

		//Just content
		$element = new UnorderedList($content);
		$this->assertInstanceOf('N8G\Grass\Components\Html\UnorderedList', $element);

		//Content and ID
		$element = new UnorderedList($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\UnorderedList', $element);

		//Content, ID and elements
		$element = new UnorderedList($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\UnorderedList', $element);

		//Content, ID, Elements and attributes
		$element = new UnorderedList($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\UnorderedList', $element);
	}
	...
	{
		$element = new UnorderedList('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Unordered List element';
		$data[1]['fixture'] = 'Unordered List element\n\r    Content: Test';
		$data[2]['fixture'] = 'Unordered List element\n\r    ID: test';
		$data[3]['fixture'] = 'Unordered List element\n\r    Elements:\n\rPHPUnit is...fun!';
		$data[4]['fixture'] = 'Unordered List element\n\r    Attributes: class=test';
		$data[5]['fixture'] = 'Unordered List element\n\r    Content: 1';
		$data[6]['fixture'] = 'Unordered List element\n\r    ID: 1';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<ul></ul>';
		$data[1]['fixture'] = '<ul>Test</ul>';
		$data[2]['fixture'] = '<ul id="test"></ul>';
		$data[3]['fixture'] = '<ul>PHPUnit is...fun!</ul>';
		$data[4]['fixture'] = '<ul class="test"></ul>';
		$data[5]['fixture'] = '<ul>1</ul>';
		$data[6]['fixture'] = '<ul id="1"></ul>';
