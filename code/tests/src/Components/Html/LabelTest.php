...
use N8G\Grass\Components\Html\Label;
use N8G\Utils\Log;
...
class LabelTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testInstantiation($content, $id, $elements, $attributes)
	{
		//No arguments
		$element = new Label();
		$this->assertInstanceOf('N8G\Grass\Components\Html\Label', $element);
		...
		//Content and ID
		$element = new Label($content, $id);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Label', $element);

		//Content, ID and elements
		$element = new Label($content, $id, $elements);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Label', $element);

		//Content, ID, Elements and attributes
		$element = new Label($content, $id, $elements, $attributes);
		$this->assertInstanceOf('N8G\Grass\Components\Html\Label', $element);
	}
	...
	{
		$element = new Label('This is a test.', 'test', array(), array('class', 'test'));
	...
	public function testValidateAttributes()
	{
		...
		//Test all the valid values of the Label
		$element->setAttributes(array('for' => 'test'));
	...
	public function toStringProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = 'Label element\n\r    Attributes: for=test';
		$data[1]['fixture'] = 'Label element\n\r    Content: Test\n\r    Attributes: for=test';
		$data[2]['fixture'] = 'Label element\n\r    ID: test\n\r    Attributes: for=test';
		$data[3]['fixture'] = 'Label element\n\r    Elements:\n\rPHPUnit is...fun!\n\r    Attributes: for=test';
		$data[4]['fixture'] = 'Label element\n\r    Attributes: class=test, for=test';
		$data[5]['fixture'] = 'Label element\n\r    Content: 1\n\r    Attributes: for=test';
		$data[6]['fixture'] = 'Label element\n\r    ID: 1\n\r    Attributes: for=test';
	...
	public function toHtmlProvider()
	{
		...
		//Add fixtures
		$data[0]['fixture'] = '<label for="test"></label>';
		$data[1]['fixture'] = '<label for="test">Test</label>';
		$data[2]['fixture'] = '<label id="test" for="test"></label>';
		$data[3]['fixture'] = '<label for="test">PHPUnit is...fun!</label>';
		$data[4]['fixture'] = '<label class="test" for="test"></label>';
		$data[5]['fixture'] = '<label for="test">1</label>';
		$data[6]['fixture'] = '<label id="1" for="test"></label>';
	...
	private function genericDataProvider()
	{
		return array(
			...
			array(
				...
				'id'			=>	null,
				'elements'		=>	array(),
				'attributes'	=>	array('class' => 'test', 'for' => 'test')
			),
			array(
				'content'		=>	1,
				'id'			=>	null,
