...
// Private functions
    ...
    /**
     * This function gets the page type data for a specific page. The ID of the specific page is passed and the
     * relevant data from the database is retrieved. The page type is then returned.
     *
